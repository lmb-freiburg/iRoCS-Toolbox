...
#ifndef IROCS_INDEXEDCOLORMAPEDITORWIDGET_HH
#define IROCS_INDEXEDCOLORMAPEDITORWIDGET_HH
...
namespace iRoCS
{
  ...
  class IndexedColormapEditorWidget
      : public QWidget, virtual public IndexedColormapObserver
  {
    ...
    IndexedColormapEditorWidget(
        IndexedColormap &colormap, QWidget *parent = NULL);
    ~IndexedColormapEditorWidget();
...
/*======================================================================*/
  ...
  private:
    ...
    QSpinBox *p_startIndexControl;
    QToolButton *p_startColorButton;
    QSpinBox *p_endIndexControl;
    QToolButton *p_endColorButton;
    IndexedColormapBarWidget *p_colorbar;
