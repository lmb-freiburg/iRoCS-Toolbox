...
TrainDetectorTrainfileParametersItem::TrainDetectorTrainfileParametersItem(
...
void TrainDetectorTrainfileParametersItem::setTrainFileName(
    std::string const &name)
{
  p_trainFileSelector->setValue(name);
}

std::string TrainDetectorTrainfileParametersItem::trainFileName() const
{
  return p_trainFileSelector->value();
}

void TrainDetectorTrainfileParametersItem::setDataChannelName(
    std::string const &name)
{
  p_dataChannelControlElement->setValue(name);
}

std::string TrainDetectorTrainfileParametersItem::dataChannelName() const
{
  return p_dataChannelControlElement->value();
}

void TrainDetectorTrainfileParametersItem::setAnnotationChannelName(
    std::string const &name)
{
  p_annotationChannelControlElement->setValue(name);
}

std::string TrainDetectorTrainfileParametersItem::annotationChannelName() const
{
  return p_annotationChannelControlElement->value();
}

void TrainDetectorTrainfileParametersItem::setCacheFileName(
    std::string const &name)
{
  p_cacheFileSelector->setValue(name);
}

std::string TrainDetectorTrainfileParametersItem::cacheFileName() const
{
  return p_cacheFileSelector->value();
}

std::string TrainDetectorTrainfileParametersItem::check(
